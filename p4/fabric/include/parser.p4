...
parser FabricParser (packet_in packet,
    ...
    state parse_ipv4 {
        ...
        meta.ip_eth_type = ETHERTYPE_IPV4;
        meta.ipv4_src_addr = hdr.ipv4.src_addr;
        meta.ipv4_dst_addr = hdr.ipv4.dst_addr;
    ...
    state parse_ipv6 {
        ...
        meta.ip_eth_type = ETHERTYPE_IPV6;
...
// #ifdef WITH_SPGW
//         meta.spgw.qfi = hdr.gtpu_ext_psc.qfi;
// #endif // WITH_SPGW
...
#ifdef WITH_SPGW
        meta.inner_l4_sport = hdr.inner_udp.sport;
        meta.inner_l4_dport = hdr.inner_udp.dport;
#endif // WITH_SPGW
#ifdef WITH_INT
        transition parse_int;
#else
...
#ifdef WITH_SPGW
        meta.inner_l4_sport = hdr.inner_tcp.sport;
        meta.inner_l4_dport = hdr.inner_tcp.dport;
#endif // WITH_SPGW
        transition accept;
    }
